...
type TableClientConfig struct {
	...
	StreamKeepaliveIntervalSeconds        int    `gorm:"default:0" json:"stream_keepalive_interval_seconds"` // Interval in seconds between SSE keepalive frames on idle streams (0 = disabled)
